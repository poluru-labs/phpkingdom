...
Examples are topic-aware (properties, directives, controllers, SSR, context, Task, localization, etc.).
...
```bash
python3 generate_lit_tutorials.py
python3 generate_lit_extra.py
```

## Course practice packs

- [`14-Exercises/`](14-Exercises/index.html) — 25 Problem → Solution Lit drills
- [`15-Templates/`](15-Templates/index.html) — 25 unique Lit starter templates
